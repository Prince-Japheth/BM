...
const BankSetupScreen = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                >
                    <Text style={styles.inputText}>{selectedBank}</Text>
                    <ArrowDown2 size={20} color="#888" />
                </TouchableOpacity>
                ...
                {/* Save Details */}
                <TouchableOpacity>
                    <Text style={styles.saveDetails}>Save details</Text>
                </TouchableOpacity>
            </View>
