...
const EditListingProfileDetails = ({ navigation, route }) => {
    ...
    const handleSubmit = () => {
        navigation.navigate('PlaceTabNavigator', { 
            screen: 'PlaceDashboard',
            params: { isAccountVerified: true }
        });
    };
        ...
        <View style={styles.container}>
            <ScrollView style={styles.scrollView}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Edit Listing Details</Text>
                </View>
                ...
                <View style={styles.formContainer}>
                    ...
                    <TextInput
                        style={styles.input} value='Amazing Grace Store'
                    />
