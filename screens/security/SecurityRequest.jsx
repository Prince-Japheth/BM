...
export default function SecurityRequest() {
    ...
    const handleDecline = async () => {
        ...
        try {
            ...
            Alert.alert(
                'Error',
                err.response?.data?.message || 'Failed to decline booking. Please try again.'
            );
        } finally {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity
                    onPress={() => navigation.navigate('AssignOfficer', {
                        security_booking_id: bookingData.security_booking_id,
                        date_booking_id: route.params?.date_booking_id
                    })}
                ...
                >
                    {isProcessing ? (
                        <ActivityIndicator color="#AD52F7" size="small" />
                    ) : (
...
const styles = StyleSheet.create({
    ...
    detailRow: {
        flexDirection: 'row', // Aligns label and value in a row
    ...
    value: {
        ...
        color: 'black',
        fontWeight: '400',
        flex: 2, // Allows the value to take more space
        textAlign: 'start', // Aligns the value to the right
    },
    specSection: {
        paddingVertical: 16,
    },
